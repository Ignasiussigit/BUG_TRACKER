...
$chat = mysqli_query($koneksi,"
  SELECT c.*, 
         u.user_nama, u.user_foto,
         a.admin_nama, a.admin_foto
  FROM pengaduan_chat c
  LEFT JOIN user u 
    ON c.pc_user = u.user_id AND c.pc_level='User'
  LEFT JOIN admin a 
    ON c.pc_user = a.admin_id AND c.pc_level='Teknisi'
...
<div class="direct-chat-msg">
  ...
  <div class="direct-chat-text">
    ...
    <a href="tiket_pesan_hapus.php?id=<?= $c['pc_id']; ?>" class="pull-right">x</a>
  </div>
</div>
