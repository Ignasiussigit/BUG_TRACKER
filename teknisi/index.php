    ...
    <div class="row">
      <section class="col-lg-12">        
       <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          <div class="inner">
            <?php 
            $tiket = mysqli_query($koneksi,"select * from pengaduan where pengaduan_status='Open'");            
            ?>
            <h3 style="font-weight: bolder"><?php echo mysqli_num_rows($tiket) ?></h3>
            <p>Jumlah Tiket Open</p>
          </div>
          <div class="icon">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-teal">
          <div class="inner">
            <?php 
            $menunggu = mysqli_query($koneksi,"select * from pengaduan where pengaduan_status='Pending'");  
            $p = mysqli_fetch_assoc($menunggu);
            ?>
            <h3 style="font-weight: bolder"><?php echo mysqli_num_rows($menunggu); ?></h3>
            <p>Jumlah Tiket Pending</p>
          </div>
          <div class="icon">
            <i class="ion ion-clipboard"></i>
          </div>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green">
          <div class="inner">
            <?php 
            $selesai = mysqli_query($koneksi,"select * from pengaduan where pengaduan_status='Progress'");            
            ?>
            <h3 style="font-weight: bolder"><?php echo mysqli_num_rows($selesai); ?></h3>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-yellow">
          <div class="inner">
            <?php 
            $helpdesk = mysqli_query($koneksi,"select * from pengaduan where pengaduan_status='Close'");
