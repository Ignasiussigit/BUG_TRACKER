            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages">
                ...
                while($c = mysqli_fetch_array($chat)){
                  $user_id = $c['pc_user'];
                  if($c['pc_level']=="User"){
                    $cek_teknisi = mysqli_query($koneksi,"select * from user where user_id='$user_id'");
                    $ct = mysqli_fetch_assoc($cek_teknisi);
                    ?>
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-left"><?php echo $ct['user_nama'] ?></span>
                      ...
                      if($ct['user_foto']==""){
                         ?>
                          ...
                          ?>
                           <img class="direct-chat-img" src="../gambar/user/<?php echo $ct['user_foto'] ?>" alt="message user image">
                          <?php
                      }
                       ?>
                    ...
                    $cek_user = mysqli_query($koneksi,"select * from admin where admin_id='$user_id'");
                    ...
                    <div class="direct-chat-msg right">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-right"><?php echo $cu['admin_nama'] ?></span>
                      ...
                      if($cu['admin_foto']==""){
                         ?>
                          ...
                          ?>
                           <img class="direct-chat-img" src="../gambar/user/<?php echo $cu['admin_foto'] ?>" alt="message user image">
                          <?php
                      }
                       ?>
