                ...
                <li>
                  ...
                  <ul class="menu">
                    ...
                    while($da = mysqli_fetch_array($pengaduan)){
                      ...
                      <li>
                        <a href="tiket.php">                                              
                          <p><?php echo $da['pengaduan_judul'] ?></p>
                        </a>
                      </li>
                      <?php
                    }
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">                         
              ...
              <li><a href="teknisi.php"><i class="fa fa-circle-o"></i> Data Teknisi</a></li>              
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">                         
              <li><a href="laporan_tiket.php"><i class="fa fa-circle-o"></i> Data Tiket</a></li>
            </ul>
          </li>
